...
bool GraphicsEngine::Init(HWND hwnd, UINT frameBufferWidth, UINT frameBufferHeight)
{
	...
	m_scissorRect.right = 2048;
	m_scissorRect.bottom = 2048;
	...
	//カメラを初期化する。
	m_camera2D.SetUpdateProjMatrixFunc(EnUpdateProjMatrixFunc::enUpdateProjMatrixFunc_Ortho);
...
void GraphicsEngine::BeginRender()
{
	...
	const float clearColor[] = { 0.7f, 0.9f, 1.0f, 1.0f };
